<div class="create">
    ...
    font-weight: bold;"><?echo $u[$i]->pseudo()?></label>

    <?
    if($u[$i]->admin()==0)
    {
    ?>
    <button type="submit" formaction="<?=BASEURL?>/index.php/user/supprimer/<?echo $u[$i]->idUtilisateur()?>">Suprimer cet utilisateurs</button>
